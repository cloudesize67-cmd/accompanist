...
For more examples, refer to the [samples](https://github.com/cloudesize67-cmd/accompanist/tree/main/sample/src/main/java/com/google/accompanist/sample/navigation/animation).
